...
var UserEntity = /** @class */ (function (_super) {
    ...
    UserEntity.prototype.toObj = function () {
        var _a = this, username = _a.username, realname = _a.realname, status = _a.status;
        return { username: username, realname: realname, status: status };
    };
    __decorate([
        typeorm_1.Column()
    ], UserEntity.prototype, "ucode");
    __decorate([
        typeorm_1.Column()
    ...
    __decorate([
        typeorm_1.Column()
    ], UserEntity.prototype, "status");
    __decorate([
        typeorm_1.Column()
    ], UserEntity.prototype, "login_count");
    __decorate([
        typeorm_1.Column()
    ], UserEntity.prototype, "last_login_ip");
    __decorate([
        typeorm_1.BeforeInsert()
    ], UserEntity.prototype, "hashPassword");
    UserEntity = __decorate([
        typeorm_1.Entity('ay_user')
    ], UserEntity);
    return UserEntity;
